...
describe('@geeeger/multisort module', () => {
  ...
  test('test multil props with funcs', () => {
    ...
    expect(JSON.stringify(newData)).toBe(
      JSON.stringify([
        {
          onlineNum: '15万',
          isOnLive: true,
